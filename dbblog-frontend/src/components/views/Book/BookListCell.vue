      ...
      <iv-row type="flex">
        <iv-col :xs="24" :sm="24" :md="textSpan" :lg="textSpan" :order="textOrderType" style="padding-left: 0;padding-right: 0;">
          <div class="text-wrapper">
            ...
            <p class="desc">{{book.description | filterHtml}}<a :href="'book/'+book.id"> 查看更多
              <iv-icon type="arrow-right-b"></iv-icon>
            </a></p>
            <p class="operate_info">
              <span class="publish-time">At time / <a href="">{{book.createTime}}</a></span>
              <span class="readings"><a href=""><iv-icon type="eye"></iv-icon> {{book.readNum}} 阅读</a></span>
              <span class="comments"><a href=""><iv-icon type="compose"></iv-icon> {{book.commentNum}} 评论</a></span>
              <span class="likes"><a href=""><iv-icon type="heart"></iv-icon> {{book.likeNum}} 喜欢</a></span>
            </p>
          </div>
        </iv-col>
